...
public:
  ...
  // Optionally expose the server URL for a stream after adding
  // (rtsp://host:port/name) Returns empty string if not running or name
  // unknown.
...
private:
  ...
  EventLoopWatchVariable eventLoopWatch_{0}; // std::atomic<char>
